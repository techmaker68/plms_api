...
<body>
  <div class="pdfDocView">
    <table class="noHover" cellpadding="0" cellspacing="0" style="border-collapse: collapse; width: 100%; background-color: white" dir="rtl">
      <tr>
        <td>
      ...
      <tr>
        <td>
          <table cellpadding="0" cellspacing="0" class="doc-wrapper">
            <tbody>
              <tr>
                <td class="direction" style="font-size: 14px; color: #000; padding-top: 15px">
                :العدد
                  <span v-if="application" class="highlight">
                    {{ $data->moi_2_ref ??''  }}
                  </span>
                </td>
              </tr>
              <tr>
                <td class="direction" style="font-size: 14px; color: #000">
                :  التاريخ
                  <span v-if="application" class="highlight">
                    {{ $data->moi_2_date ??'' }}
                  </span>
              ...
              <tr>
                <td class="direction" style="font-size: 14px; color: #000; padding-top: 50px">
                  <strong> الى/ وزارة الداخلية/ مديرية شؤون الإقامة </strong>
                </td>
              </tr>
              <tr>
                <td class="direction" style="font-size: 14px; color: #000; padding-top: 20px">
                  <strong>
                    الموضوع/<u>طلب منح سمات دخول متعددة{{
              ...
              <tr>
                <td class="direction" style="font-size: 14px; color: #000; padding-top: 30px">
              ...
              <tr>
                <td class="direction" style="font-size: 14px; color: #000; padding-top: 10px">
                  وتنتهي بالتسلسل
                </td>
              </tr>
              <tr>
